...
using FBLARoverAgenda_Backend.Infrastructure.Common;
using FBLARoverAgenda_Backend.Infrastructure.Common.Email.Services;
using FBLARoverAgenda_Backend.Infrastructure.Common.Extensions;
using FBLARoverAgenda_Backend.Infrastructure.Common.Hangfire.Filters;
using FBLARoverAgenda_Backend.Infrastructure.Common.Seeder.Services;
using FBLARoverAgenda_Backend.Infrastructure.Common.Settings.Services;
using FBLARoverAgenda_Backend.Infrastructure.Common.Templates;
...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        {
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "FBLARoverAgenda_Backend.Web API", Version = "v1" });
